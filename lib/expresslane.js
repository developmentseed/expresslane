...
var globalMessages = new Messages();
...
var configure = function(settingsPath) {
    ...
    app.configure(function() {
        ...
        // Reset globalMessages at start of request.
        app.use(function(req, res, next) {
            globalMessages.reset();
            // TODO: per-page messages would be trivial:
            // res.messages = new Messages();
            next();
        });
        ...
        app.dynamicHelpers({
            ...
            globalMessage: function(req, res) {
                return globalMessages.render(req, res);
            },
